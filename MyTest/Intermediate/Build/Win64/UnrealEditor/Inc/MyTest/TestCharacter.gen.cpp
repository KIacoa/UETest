...
#include "MyTest/Public/TestCharacter.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTestCharacter() {}
// Cross Module References
	MYTEST_API UClass* Z_Construct_UClass_ATestCharacter_NoRegister();
	MYTEST_API UClass* Z_Construct_UClass_ATestCharacter();
...
// End Cross Module References
	...
	template<> MYTEST_API UClass* StaticClass<ATestCharacter>()
	{
		return ATestCharacter::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ATestCharacter);
	struct Z_CompiledInDeferFile_FID_MyTest_Source_MyTest_Public_TestCharacter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyTest_Source_MyTest_Public_TestCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATestCharacter, ATestCharacter::StaticClass, TEXT("ATestCharacter"), &Z_Registration_Info_UClass_ATestCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATestCharacter), 3931202907U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyTest_Source_MyTest_Public_TestCharacter_h_3541446622(TEXT("/Script/MyTest"),
		Z_CompiledInDeferFile_FID_MyTest_Source_MyTest_Public_TestCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyTest_Source_MyTest_Public_TestCharacter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
